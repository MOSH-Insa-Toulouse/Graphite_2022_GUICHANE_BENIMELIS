...
void action4() {
  ecranOLED.clearDisplay();
  float Rmax = 100000000;  //On définit Rmax et Rminpour pouvoir ramener la valeur de la résistance de 0 à 64 (pixels)
  float Rmin = 10000000;
  int i = 0;
  float resistance;
  ...
  while (millis() != 64){
    ...
    if (millis() - previousMillis >= interval) {
      ...
      if ((resistanceNormee >= 64) && (resistanceNormee <= 49) && (x == 15)){
        ecranOLED.clearDisplay();
        ecranOLED.setTextSize(2);
        ecranOLED.setCursor(0, 0);
        ecranOLED.println("PERDU!");
      ...
      if ((resistanceNormee >= 54) && (resistanceNormee <= 34) && (x == 46)){
        ecranOLED.clearDisplay();
        ecranOLED.setTextSize(2);
        ecranOLED.setCursor(0, 0);
        ecranOLED.println("PERDU!");
